...
[![Türkçe](https://img.shields.io/badge/Dil-Türkçe-red?style=for-the-badge)](#-türkçe)

![Python 3.8+](https://img.shields.io/badge/python-3.8+-blue.svg)
![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)
![Platform: Linux | macOS | Windows](https://img.shields.io/badge/platform-Linux%20|%20macOS%20|%20Windows-lightgrey.svg)
...
git clone [https://github.com/KULLANICI_ADIN/Nexus-OSINT.git](https://github.com/KULLANICI_ADIN/Nexus-OSINT.git)

# 2. Navigate to the directory
cd Nexus-OSINT

# 3. Install required dependencies 
# (The flag is added to bypass PEP 668 restrictions on modern Linux distros)
...
Çevrimdışı Önbellek (Offline Mode): İnternet bağlantınız kopsa veya izole bir ağda olsanız bile, önbelleğe alınmış yerel veritabanı ile araçlar arasında gezinmeye devam edin.
...
# (Modern Linux'lardaki PEP 668 kısıtlamasını aşmak için bayrak eklenmiştir)
pip install -r requirements.txt --break-system-packages
